...
/*++{7}++*/public class /*++{2}++*//*--*/DTOBase/*--*/
	 ...
	 */
	public /*++{2}++*//*--*/DTOBase/*--*/() /*++'++*/{/*++'++*/
		relationship = LiContext.get(RelationshipFactory.class).getInstance(/*++{2}Constants++*//*--*/Constants/*--*/.RESOURCE_LOCATOR);
...
{3}
	...
	public void set/*++{1}++*/(/*++{2}++*//*--*/Object/*--*/ value) /*++'++*/{/*++'++*/
		/*++{4}++*/ValueExtractor valueExtractor = LiContext.get(SelectorConfigure.class).getValueExtractors().selectValueExtractor(
