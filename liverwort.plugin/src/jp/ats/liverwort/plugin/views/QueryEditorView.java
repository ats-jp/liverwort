package jp.ats.liverwort.plugin.views;
...
import jp.ats.liverwort.plugin.TextDialog;
import jp.ats.liverwort.plugin.views.element.EditorRootElement;
...
public class QueryEditorView extends AbstractView {
	...
	public QueryEditorView() {
		LiverwortPlugin.getDefault().setQueryEditorView(this);
	}
	...
	private class MyTreeContentProvider implements ITreeContentProvider {
		...
		private void reset() {
			if (LiverwortPlugin.getDefault().getProject() == null) {
			...
			ColumnRepositoryFactory factory = LiverwortPlugin.getDefault()
