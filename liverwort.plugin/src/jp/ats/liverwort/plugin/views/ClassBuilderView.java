...
import jp.ats.liverwort.plugin.views.element.ORMGeneratorRootElement;
...
public class ClassBuilderView extends AbstractView {
	...
	private class MyTreeContentProvider implements ITreeContentProvider {
		...
		private void reset() {
			...
			root = new ORMGeneratorRootElement(
				LiverwortPlugin.getDefault().getSchemaNames());
		}
	}
	...
	public ClassBuilderView() {
		LiverwortPlugin.getDefault().setClassBuilderView(this);
	}
