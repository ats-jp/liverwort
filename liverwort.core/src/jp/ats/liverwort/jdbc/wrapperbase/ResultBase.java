...
/**
 * {@link LiResult} のラッパーを実装するベースとなる、抽象基底クラスです。
 *
 * @author 千葉 哲嗣
 */
public abstract class ResultBase implements LiResult {

	private final LiResult base;
	 ...
	 */
	protected ResultBase(LiResult base) {
		this.base = base;
	}
