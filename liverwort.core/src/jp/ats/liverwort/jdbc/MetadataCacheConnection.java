...
import jp.ats.liverwort.jdbc.MetadataCache.Request;
...
class MetadataCacheConnection extends ConnectionBase {
	...
	private final MetadataCache cache = LiContext.get(MetadataCache.class);

	MetadataCacheConnection(LiConnection conn) {
		super(conn);
	}
