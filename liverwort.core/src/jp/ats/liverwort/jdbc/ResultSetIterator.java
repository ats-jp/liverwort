...
/**
 * {@link LiResultSet} を、 {@link Iterator} として扱えるようにするラッパークラスです。
 *
 * @author 千葉 哲嗣
 */
public class ResultSetIterator implements Iterable<Map<String, ?>>, Iterator<Map<String, ?>> {

	private final LiResultSet set;
	 ...
	 */
	public ResultSetIterator(LiResultSet set) {
		this.set = set;
	}
	...
	/**
	 * {@link LiResultSet} を一つ進め、一行の値を項目名がキーとなる {@link Map} として返します。
	 * <br>
