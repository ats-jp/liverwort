 ...
 *
 * @author 千葉 哲嗣
 * @see LiManager#initialize(Initializer)
 */
public final class Initializer {
	...
	/**
	 * Liverwort が使用する {@link TransactionFactory} を設定します。
	 * <br>
	 * {@link TransactionFactory} は、必ず設定する必要があります。
	 *
	 * @param transactionFactoryClass {@link TransactionFactory} を実装したクラス
	 * @throws IllegalStateException 既に {@link LiManager#initialize(Initializer)} を実行している場合
	 */
	...
	/**
	 * Liverwort が使用する {@link ErrorConverter} を設定します。
	 *
	...
	/**
	 * Liverwort が使用する {@link DataTypeConverter} を設定します。
	 *
	...
	/**
	 * Liverwort が使用する {@link MetadataFactory} を設定します。
	 *
	...
	/**
	 * Liverwort が使用するスキーマ名を登録します。
	 * <br>
	 * Liverwort を動作させるには、最低でも一つスキーマ名が必要です。
	 *
	...
	/**
	 * Liverwort が実行する SQL 文を、 {@link Initializer#setLogOutput(PrintStream)} で定義した出力先に出力するかどうかを設定します。
	 *
	...
	/**
	 * Liverwort が生成する SQL 文の出力する先を設定します。
	 * <br>
	...
	/**
	 * Liverwort 内のクラスが使用するオプションをセットします。
	 *
	 * @param options オプション
	 */
