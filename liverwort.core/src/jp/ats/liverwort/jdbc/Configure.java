...
public final class Configure {
	...
	/**
	 * Liverwort が実行する SQL 文を出力するかどうかを検査します。
	 *
	...
	/**
	 * Liverwort が生成する SQL 文を出力する先を返します。
	 *
	 * @return SQL 文を出力する先
	 * @throws IllegalStateException 古い設定を使用している場合
	 */
	...
	/**
	 * この設定が現在の Liverwort の設定かどうか検査します。
	 *
	 * @return 現在の Liverwort の設定かどうか
	 */
	public boolean isCurrent() {
		return LiContext.get(LiManager.class).isCurrent(this);
	}
