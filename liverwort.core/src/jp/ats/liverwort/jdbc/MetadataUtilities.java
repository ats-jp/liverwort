...
public class MetadataUtilities {
	...
	public static ResourceLocator[] getTables(final String schemaName) {
		return LiContext.get(LiManager.class).getConnection().getTables(schemaName);
	}
	...
	public static ColumnMetadata[] getColumnMetadatas(final ResourceLocator locator) {
		return LiContext.get(LiManager.class).getConnection().getColumnMetadatas(locator);
	}
	...
	public static String[] getPrimaryKeyColumnNames(final ResourceLocator locator) {
		return LiContext.get(LiManager.class).getConnection().getPrimaryKeyMetadata(locator).getColumnNames();
	}
	...
	public static String getPrimaryKeyName(ResourceLocator locator) {
		return LiContext.get(LiManager.class).getConnection().getPrimaryKeyMetadata(locator).getName();
	}
	...
	public static ResourceLocator[] getResourcesOfImportedKey(ResourceLocator locator) {
		return LiContext.get(LiManager.class).getConnection().getResourcesOfImportedKey(locator);
	}
	...
	public static ResourceLocator[] getResourcesOfExportedKey(ResourceLocator locator) {
		return LiContext.get(LiManager.class).getConnection().getResourcesOfExportedKey(locator);
	}
	...
	public static CrossReference[] getCrossReferences(ResourceLocator exported, ResourceLocator imported) {
		return LiContext.get(LiManager.class).getConnection().getCrossReferences(exported, imported);
	}
	...
	public static String regularize(String name) {
		return LiContext.get(LiManager.class).getConnection().regularize(name);
	}
	...
	public static String[] regularize(String[] names) {
		...
		LiConnection connection = LiContext.get(LiManager.class).getConnection();
