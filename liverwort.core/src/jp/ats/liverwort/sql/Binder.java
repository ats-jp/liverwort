...
/**
 * {@link LiPreparedStatement} に単一の値を設定するクラスです。
 * <br>
 * サブクラスは、 {@link LiPreparedStatement} に、具体的にどの型で値を設定するかを知っている必要があります。
 *
 * @author 千葉 哲嗣
 */
public abstract class Binder implements Bindable {
	...
	/**
	 * {@link LiPreparedStatement} にこのインスタンスの持つ値を設定します。
	 * <br>
	 ...
	 */
	public abstract void bind(int index, LiPreparedStatement statement);
