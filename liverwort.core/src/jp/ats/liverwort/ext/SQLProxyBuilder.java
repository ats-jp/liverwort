...
import jp.ats.liverwort.selector.ValueExtractors;
 ...
 * <br>
 * あらかじめ用意しておいた SQL 文とは、一つの SQL 文を一つのファイルに記述し、そのファイル名を
 * <br>
 * interface-name#method-name.sql
 * <br>
 * として、インターフェイスと同じ場所に配備したもののことです。
 * <br>
 * インターフェイスに定義するメソッドは、戻り値に
 * <br>
 * {@link LiResultSet}, int, boolean, void
 * <br>
 * を使用することができます。
 * <br>
...
public class SQLProxyBuilder {
	...
	private static class SQLProxyInvocationHandler implements InvocationHandler {
		...
		public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
			...
			ValueExtractors extractors = LiContext.get(SelectorConfigure.class).getValueExtractors();
			...
			LiStatement statement = LiContext.get(LiManager.class).getConnection().getStatement(sql, s -> {
			...
			if (returnType.equals(LiResultSet.class)) {
