...
import static jp.ats.liverwort.ext.ParsableOptionKey.OptionValueParser.TO_STRING;
import static jp.ats.liverwort.ext.ParsableOptionKey.OptionValueParser.TO_BOOLEAN;
import static jp.ats.liverwort.ext.ParsableOptionKey.OptionValueParser.TO_CLASS;
import static jp.ats.liverwort.ext.ParsableOptionKey.OptionValueParser.TO_STRING_ARRAY;
...
/**
 * Liverwort の起動に必要となる情報のキーを定めた定数インターフェイスです
 */
