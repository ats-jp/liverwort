...
import jp.ats.liverwort.jdbc.Transaction;
import jp.ats.liverwort.orm.DataAccessHelper.BatchStatementFacade;
import jp.ats.liverwort.orm.DataAccessHelper.StatementFacade;
...
import jp.ats.liverwort.sql.binder.BigDecimalBinder;
import jp.ats.liverwort.sql.binder.BlobBinder;
import jp.ats.liverwort.sql.binder.BooleanBinder;
import jp.ats.liverwort.sql.binder.ByteArrayBinder;
import jp.ats.liverwort.sql.binder.ClobBinder;
import jp.ats.liverwort.sql.binder.DoubleBinder;
import jp.ats.liverwort.sql.binder.FloatBinder;
...
import jp.ats.liverwort.sql.binder.ObjectBinder;
...
public class UpdatableDataObject
	 ...
	 * @see jp.ats.liverwort.jdbc.LiTransaction#commit()
	 */
	...
	private synchronized boolean updateInternal(StatementFacade statement) {
		...
		if (!relationship.isRoot()) {
			...
			Relationship root = LiContext.get(RelationshipFactory.class).getInstance(relationship.getResourceLocator());
		...
		if (autoCommit) {
			...
			LiContext.get(LiManager.class).synchroniseWithCurrentTransaction(this);
		}
